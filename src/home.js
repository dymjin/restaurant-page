function home() {
    ...
    [p_header_1, p_header_2, p_header_3].forEach(header => header.classList.add('title'))
    ...
    [p_main_1, p_main_2, p_main_3].forEach(main => main.classList.add('p-main'));

    [p_item_1, p_item_2, p_item_3].forEach((item, index) => {
        item.appendChild([p_header_1, p_header_2, p_header_3][index]);
        item.appendChild([p_main_1, p_main_2, p_main_3][index]);
        item.classList.add('p-item');
        p_wrapper.appendChild(item);
    });
